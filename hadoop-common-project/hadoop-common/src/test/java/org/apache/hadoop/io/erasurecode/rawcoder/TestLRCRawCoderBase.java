...
/**
 * Test base for raw LRC coders.
 * TODO: none of these pass, because we don't have LRC decoder implemented yet.
 */
public abstract class TestLRCRawCoderBase extends TestRawCoderBase {
    ...
    public void testCoding_6x3_erasing_d0() {
        prepare(null, 6, 2, 2, new int[]{0}, new int[0]);
        testCodingDoMixAndTwice();
    }
