...
public abstract class ErasureDecoder extends Configured
  ...
  protected  int numDataUnitsFinal;
  protected int numParityUnitsFinal;
  ...
  public ErasureDecoder(ErasureCoderOptions options) {
    ...
    this.numDataUnitsFinal = options.getNumDataUnitsFinal();
    this.numParityUnitsFinal = options.getNumParityUnitsFinal();
  }
