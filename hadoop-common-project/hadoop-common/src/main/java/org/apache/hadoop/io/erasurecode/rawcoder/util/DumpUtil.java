...
public final class DumpUtil {
  ...
  public static void dumpBytes(String header, byte[] bytes) {
    System.out.print(header);
    System.out.print("("+bytes.length+"): ");
    String str = bytesToHex(bytes, -1);
    System.out.println(str);
    System.out.println();
  }

  public static void dumpArrayOfBytes(String header, byte[][] ArrayOfBytes) {
    System.out.println("Dumping num_chunks="+ArrayOfBytes.length);
