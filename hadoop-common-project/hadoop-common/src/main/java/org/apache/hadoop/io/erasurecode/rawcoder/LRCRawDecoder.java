...
/**
 * A raw erasure decoder in Local Reconstructon code scheme in pure Java.
 *
 *
 *
 */
...
public class LRCRawDecoder extends RawErasureDecoder {
    ...
    public LRCRawDecoder(ErasureCoderOptions coderOptions) {
        ...
        RSUtil.genLRCMatrix(encodeMatrix, numAllUnits, getNumLocalParityUnits(), getNumDataUnits());
        if (allowVerboseDump()) {
