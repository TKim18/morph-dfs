...
public class NativeRSRawEncoder extends AbstractNativeRawEncoder {
  ...
  public NativeRSRawEncoder(ErasureCoderOptions coderOptions) {
    super(coderOptions);
    LOG.info("Encoding with NativeRSRawEncoder");
  ...
  @Override
  protected void performUpdateImpl(
    ByteBuffer[] inputs, int[] inputOffsets, int dataLen,
    ByteBuffer[] outputs, int[] outputOffsets,
    int offset, int length) throws IOException {
    updateImpl(inputs, inputOffsets, dataLen, outputs, outputOffsets, offset, length);
  }
  ...
  private native void updateImpl(ByteBuffer[] inputs, int[] inputOffsets,
                                 int dataLen, ByteBuffer[] outputs,
                                 int[] outputOffsets, int offset, int length) throws IOException;
