...
public final class ErasureCodeConstants {
  ...
  public static final String CC_CODEC_NAME = "cc";
  public static final String BCC_CODEC_NAME = "bcc";
  public static final String LRC_CODEC_NAME = "lrc";
  ...
  public static final ECSchema CC_3_3_SCHEMA = new ECSchema(
      CC_CODEC_NAME, 3, 3);

  public static final ECSchema CC_9_3_SCHEMA = new ECSchema(
          CC_CODEC_NAME, 9, 3);

  public static final ECSchema CC_12_3_SCHEMA = new ECSchema(
      CC_CODEC_NAME, 12, 3);

  public static final ECSchema BCC_6_1_2_SCHEMA = new ECSchema(
          BCC_CODEC_NAME, 6, 1, 12, 2, null);

  public static final ECSchema BCC_6_2_4_SCHEMA = new ECSchema(
          BCC_CODEC_NAME, 6, 2, 12, 4, null);

  public static final ECSchema BCC_12_2_0_SCHEMA = new ECSchema(
          BCC_CODEC_NAME, 12, 2, 12, 2, null);


  public static final ECSchema RS_12_3_SCHEMA = new ECSchema(
          RS_CODEC_NAME, 12, 3);

  public static final ECSchema RS_3_2_SCHEMA = new ECSchema(
      RS_CODEC_NAME, 3, 2);

  public static final ECSchema RS_6_1_SCHEMA = new ECSchema(
          RS_CODEC_NAME, 6, 1);

  public static final ECSchema RS_12_2_SCHEMA = new ECSchema(
          RS_CODEC_NAME, 12, 2);
  ...
  public static final ECSchema LRC_12_2_2_SCHEMA = new ECSchema(
          LRC_CODEC_NAME, 12, 2, 2);
