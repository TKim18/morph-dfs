...
public abstract class RawErasureDecoder {
  ...
  static final Logger LOG = LoggerFactory.getLogger(RawErasureDecoder.class);
  ...
  public void decode(byte[][] inputs, int[] erasedIndexes, byte[][] outputs)
      throws IOException {
    LOG.info("[BWOCC]-d Decoding Data with byte[][].!");
  ...
  public void decode(ECChunk[] inputs, int[] erasedIndexes,
    ...
    LOG.info("[BWOCC]-d Decoding Data with ECChunk.!");
  ...
  public int getNumParityUnitsFinal() {
    return coderOptions.getNumParityUnitsFinal();
  }
