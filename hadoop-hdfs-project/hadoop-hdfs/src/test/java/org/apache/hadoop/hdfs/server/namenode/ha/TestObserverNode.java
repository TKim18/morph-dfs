...
public class TestObserverNode {
  ...
  public void testObserverNodeSafeModeWithBlockLocations() throws Exception {
    ...
    doAnswer((invocation) -> {
      ...
      return new LocatedBlocks(0, false, fakeBlocks, null, null, true, null, null);
    }).when(bmSpy).createLocatedBlocks(any(), any(), anyLong(), anyBoolean(),
  ...
  public void testObserverNodeBlockMissingRetry() throws Exception {
    ...
    doAnswer((invocation) -> {
      ...
      fakeBlocks.add(fakeBlock);
      return new LocatedBlocks(0, false, fakeBlocks, null, null, true, null, null);
    }).when(bmSpy).createLocatedBlocks(Mockito.any(), any(), anyLong(),
