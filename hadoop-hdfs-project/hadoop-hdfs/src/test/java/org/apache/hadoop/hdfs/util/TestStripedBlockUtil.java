...
public class TestStripedBlockUtil {
  ...
  @Test
  public void testParseDummyDatanodeInfos() {
    LocatedStripedBlock lsb = createDummyLocatedBlock(
            (long) stripeSize * stripesPerBlock);
    DatanodeInfo[] dns = parseDataBlockLocations(lsb, 3);
    System.out.println(Arrays.toString(dns));
  }
