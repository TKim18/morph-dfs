...
:main
  ...
  set hdfscommands=dfs namenode secondarynamenode journalnode zkfc datanode dfsadmin haadmin fsck balancer jmxget oiv oev fetchdt getconf groups snapshotDiff lsSnapshottableDir cacheadmin mover ectransitioner storagepolicies classpath crypto dfsrouter dfsrouteradmin debug
...
:ectransitioner
  set CLASS=org.apache.hadoop.hdfs.server.ectransitioner.ECTransitioner
  set HADOOP_OPTS=%HADOOP_OPTS% %HADOOP_EC_TRANS_OPTS%
  goto :eof
...
:print_usage
  ...
  @echo   ectransitioner       transition files across erasurecoding policies
