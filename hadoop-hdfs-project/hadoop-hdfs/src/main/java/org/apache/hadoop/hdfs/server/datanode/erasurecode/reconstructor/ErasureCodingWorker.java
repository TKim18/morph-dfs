...
public final class ErasureCodingWorker {
  ...
  private void initializeStripedBlkReconstructionThreadPool(int numThreads) {
    LOG.info("Using striped block reconstruction; pool threads={}",
        numThreads);
  ...
  public void processErasureCodingTasks(
    ...
    LOG.info("Received request to process erasure coding task");
    for (BlockECReconstructionInfo reconInfo : ecTasks) {
      try {
        LOG.info("New recon info: {}", reconInfo);
        StripedReconstructionInfo stripedReconInfo =
            new StripedReconstructionInfo(
            reconInfo.getExtendedGroup(), reconInfo.getErasureCodingPolicy(),
