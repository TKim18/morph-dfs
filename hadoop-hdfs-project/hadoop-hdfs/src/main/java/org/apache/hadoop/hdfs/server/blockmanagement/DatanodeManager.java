...
import static org.apache.hadoop.hdfs.server.protocol.DatanodeProtocol.DNA_ERASURE_TRANSCODING;
...
public class DatanodeManager {
  ...
  public DatanodeCommand[] handleHeartbeat(DatanodeRegistration nodeReg,
    ...
    int numTranscodeTasks = nodeinfo.getNumberOfBlocksToBeErasureTranscoded();
    if (numTranscodeTasks > 0) {
      List<BlockECTranscodeCommand.BlockECTranscodeInfo> pendingTranscode =
          nodeinfo.getErasureTranscodeCommand(numTranscodeTasks);
      cmds.add(new BlockECTranscodeCommand(DNA_ERASURE_TRANSCODING, pendingTranscode));
    }
