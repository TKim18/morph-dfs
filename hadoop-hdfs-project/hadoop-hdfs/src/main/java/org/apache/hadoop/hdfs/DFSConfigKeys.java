...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final int     DFS_NAMENODE_EC_POLICIES_MAX_CELLSIZE_DEFAULT = 8 * 1024 * 1024;
  ...
  public static final String  DFS_DN_EC_TRANSCODER_THREADS_KEY = "dfs.datanode.ec.transcoder.threads";
  public static final int     DFS_DN_EC_TRANSCODER_THREADS_DEFAULT = 8;
...
//  public static final long    DFS_BLOCKREPORT_INTERVAL_MSEC_DEFAULT = 6 * 60 * 60 * 1000;
  public static final long    DFS_BLOCKREPORT_INTERVAL_MSEC_DEFAULT = 2 * 60 * 1000;  // setting default to 2 minutes to test
