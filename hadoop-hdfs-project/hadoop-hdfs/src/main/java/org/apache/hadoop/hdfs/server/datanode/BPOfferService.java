...
//    LOG.info("In notify namenode block");
//    LOG.info("Storage info = {}, block info = {}", storage, info);
  ...
  private boolean processCommandFromActive(DatanodeCommand cmd,
    ...
    // LOG.info("Datanode received command from Namenode = {}", cmd.getAction());
    ...
    case DatanodeProtocol.DNA_ERASURE_TRANSCODING:
      LOG.info("DatanodeCommand action: DNA_ERASURE_TRANSCODING");
      Collection<BlockECTranscodeInfo> etcTasks =
        ((BlockECTranscodeCommand) cmd).getTranscodeTasks();
      dn.getErasureTranscodingWorker().processTranscoderTasks(etcTasks);
      break;
    default:
