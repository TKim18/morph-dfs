...
import org.apache.hadoop.hdfs.protocol.proto.ClientDatanodeProtocolProtos.TriggerCellMovementRequestProto;
import org.apache.hadoop.hdfs.protocol.proto.ClientDatanodeProtocolProtos.TriggerCellMovementResponseProto;
...
public class ClientDatanodeProtocolServerSideTranslatorPB implements
  ...
  @Override
  public TriggerCellMovementResponseProto triggerCellMovement(
          RpcController controller, TriggerCellMovementRequestProto request)
          throws ServiceException {
    try {
      impl.triggerCellMovement(PBHelperClient.convert(request.getBlock()),
        request.getOffset(),
        request.getNumBytes());
      return TriggerCellMovementResponseProto.newBuilder().build();
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
