...
import org.apache.hadoop.hdfs.server.namenode.FSEditLogOp.ModifyErasureCodingPolicyOp;
...
public class FSEditLogLoader {
  ...
  private long applyEditLogOp(FSEditLogOp op, FSDirectory fsDir,
    ...
    case OP_REMOVE_ERASURE_CODING_POLICY:
      ...
      break;
    case OP_MODIFY_ERASURE_CODING_POLICY:
      FSEditLogOp.ModifyErasureCodingPolicyOp modifyOp = (ModifyErasureCodingPolicyOp) op;
      INodesInPath iip = fsDir.getINodesInPath(modifyOp.path, DirOp.WRITE);
      ErasureCodingPolicy policy = fsNamesys.getErasureCodingPolicyManager().getByID(modifyOp.ecPolicyId);
      FSNamesystem.LOG.info("Rolling forward edit on modify ecpolicy file={}, policy={}",
        iip.getPath(), policy);
      FSDirErasureCodingOp.unprotectedSetFileErasureCodingPolicy(fsNamesys, iip, policy, false);
      break;
    default:
