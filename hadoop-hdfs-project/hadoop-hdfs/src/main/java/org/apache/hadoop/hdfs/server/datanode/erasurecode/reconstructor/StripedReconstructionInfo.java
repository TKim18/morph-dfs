...
public class StripedReconstructionInfo {
  ...
  public StripedReconstructionInfo(ExtendedBlock blockGroup,
      ...
      byte[] targetIndices) {
    this(new ExtendedGroup(blockGroup), ecPolicy, liveIndices, sources, targetIndices, null,
        null, null);
  }

  StripedReconstructionInfo(ExtendedGroup blockGroup,
      ErasureCodingPolicy ecPolicy, byte[] liveIndices, DatanodeInfo[] sources,
  ...
  private StripedReconstructionInfo(ExtendedGroup blockGroup,
      ErasureCodingPolicy ecPolicy, byte[] liveIndices, DatanodeInfo[] sources,
      byte[] targetIndices, DatanodeInfo[] targets,
      StorageType[] targetStorageTypes, String[] targetStorageIds) {

    this.blockGroup = blockGroup.getBlock();
    ...
    this.blockIdOffsets = blockGroup.getBlockIdOffsets();
    this.blockLengths = blockGroup.getBlockLengths();
  }
  ...
  int[] getBlockIdOffsets() {
    return blockIdOffsets;
  }

  long[] getBlockLengths() {
    return blockLengths;
  }
