...
public interface DatanodeProtocol {
  ...
  final static int DNA_ERASURE_TRANSCODING = 12;  // erasure transcoding command
  int DNA_BLOCK_STORAGE_MOVEMENT = 13; // block storage movement command
  int DNA_DROP_SPS_WORK_COMMAND = 14; // drop sps work command
