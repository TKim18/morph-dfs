...
public class DatanodeDescriptor extends DatanodeInfo {
  ...
  private final BlockQueue<BlockECReconstructionInfo> erasurecodeBlocks =
      new BlockQueue<>();
  /** A queue of blocks to be erasure transcoded by this datanode */
  private final BlockQueue<BlockECTranscodeInfo> transcodeBlocks =
      new BlockQueue<>();
   ...
   */
  void addBlockToBeErasureCoded(ExtendedGroup block,
  ...
  void addBlockToBeTranscoded(ExtendedGroup group, DatanodeDescriptor[] dataSources,
    ...
    BlockECTranscodeInfo task = new BlockECTranscodeInfo(group, dataSources, ecPolicy,
        targets, parityBlocks, paritySources, oldSchema);
    transcodeBlocks.offer(task);
  }
  ...
  @VisibleForTesting
  public int getNumberOfBlocksToBeErasureTranscoded() {
    return transcodeBlocks.size();
  }
  ...
  public List<BlockECTranscodeInfo> getErasureTranscodeCommand(
      int maxOps) {
    return transcodeBlocks.poll(maxOps);
  }
  ...
  public String dumpDatanode() {
    ...
    int tc = transcodeBlocks.size();
    if (tc > 0) {
      sb.append(" ").append(tc).append(" blocks to be erasure transcoded;");
    }
