...
public class DatanodeStorageInfo {
  ...
  public static final Logger logger = NameNode.blockStateChangeLog;
  ...
  /**
   * Used this to manually set storage on a redundancy group at the specified index
   * @param b
   * @param index
   */
  public void setBlock(BlockInfoGrouped b, int index) {
    // Use this to attach a storage to a block
    b.setStorageInfo(index, this);
  }
