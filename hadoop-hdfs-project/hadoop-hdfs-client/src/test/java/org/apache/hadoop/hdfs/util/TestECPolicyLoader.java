...
public class TestECPolicyLoader {
   ...
   */
  @Test
  public void testLoadSpecialECPolicy() throws Exception {
    PrintWriter out = new PrintWriter(new FileWriter(POLICY_FILE));
    out.println("<?xml version=\"1.0\"?>");
    out.println("<configuration>");
    out.println("<layoutversion>1</layoutversion>");
    ...
    out.println("    <m>4</m>");
    out.println("  </schema>");
    out.println("  <schema id=\"LRCk12m2l2\">");
    out.println("    <codec>LRC</codec>");
    out.println("    <k>12</k>");
    out.println("    <m>2</m>");
    out.println("    <l>2</l>");
    out.println("  </schema>");
    out.println("  <schema id=\"BCCk6m1kf12mf2\">");
    out.println("    <codec>BCC</codec>");
    out.println("    <k>6</k>");
    out.println("    <m>1</m>");
    out.println("    <kf>12</kf>");
    out.println("    <mf>2</mf>");
    out.println("  </schema>");
    out.println("</schemas>");
    out.println("<policies>");
    ...
    out.println("  </policy>");
    out.println("  <policy>");
    out.println("    <schema>LRCk12m2l2</schema>");
    out.println("    <cellsize>131072</cellsize>");
    out.println("  </policy>");
    out.println("  <policy>");
    out.println("    <schema>BCCk6m1kf12mf2</schema>");
    out.println("    <cellsize>262144</cellsize>");
    out.println("  </policy>");
    out.println("</policies>");
    out.println("</configuration>");
    ...
    ErasureCodingPolicy policy3 = policies.get(2);
    ECSchema schema3 = policy3.getSchema();
    assertEquals(131072, policy3.getCellSize());
    assertEquals(1, schema3.getExtraOptions().size());
    assertEquals(12, schema3.getNumDataUnits());
    assertEquals(2, schema3.getNumLocalParityUnits());
    assertEquals(2, schema3.getNumParityUnits());
    assertEquals("LRC", schema3.getCodecName());

    ErasureCodingPolicy policy4 = policies.get(3);
    ECSchema schema4 = policy4.getSchema();
    assertEquals(262144, policy4.getCellSize());
    assertEquals(2, schema4.getExtraOptions().size());
    assertEquals(6, schema4.getNumDataUnits());
    assertEquals(1, schema4.getNumParityUnits());
    assertEquals(12, schema4.getNumDataUnitsFinal());
    assertEquals(2, schema4.getNumParityUnitsFinal());
    assertEquals("BCC", schema4.getCodecName());
  }
