...
public abstract class DataTransferProtoUtil {
  static BlockConstructionStage fromProto(
      DataTransferProtos.BlockConstructionStageProto stage) {
    return BlockConstructionStage.valueOf(stage.name());
  }

  static DataTransferProtos.BlockConstructionStageProto toProto(
      BlockConstructionStage stage) {
    return DataTransferProtos.BlockConstructionStageProto.valueOf(stage.name());
  }
