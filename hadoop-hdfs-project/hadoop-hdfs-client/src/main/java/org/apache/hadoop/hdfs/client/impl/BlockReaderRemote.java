...
public class BlockReaderRemote implements BlockReader {
  ...
  public static BlockReader newBlockReader(String file,
    ...
    LOG.debug("Send read block message in {} ms", System.currentTimeMillis() - startTime);
    ...
    LOG.debug("Got back read block response in {} ms", System.currentTimeMillis() - startTime);
