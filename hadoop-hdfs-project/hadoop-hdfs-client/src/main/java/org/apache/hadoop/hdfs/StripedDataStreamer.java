...
import org.apache.hadoop.hdfs.Coordinator;
...
public class StripedDataStreamer extends DataStreamer {
  ...
  private final int index;  // this is the logical index within coordinator

  private DatanodeInfo node;
