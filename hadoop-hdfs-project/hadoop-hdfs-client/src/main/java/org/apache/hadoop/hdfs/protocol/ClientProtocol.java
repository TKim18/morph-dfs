...
public interface ClientProtocol {
  ...
  /**
   * Same as addBlock but adds a hybrid type block
   * @param src
   * @param clientName
   * @param previous
   * @param excludeNodes
   ...
   */
  @Idempotent
  LocatedBlock addHybridBlock(String src, String clientName,
  ...
  /**
   * Same as addBlock() but has the capability to ask for multiple
   * stripes or groups in a single RPC call to NameNode.
   * Used for efficiency purposes.
   * @return locatedBlocks
   * @throws IOException
   */
  @Idempotent
  LocatedBlock[] addBlocks(String src, String clientName,
   ...
   */
  @Idempotent
  boolean complete(String src, String clientName, ExtendedBlock last,
                   ExtendedBlock[] parities, long fileId)
          throws IOException;
  ...
  /**
   * Set the data stripe width for files in a directory
   * @param src The directory to set stripe width on.
   * @param stripeWidth The units to stripe across.
   */
  @AtMostOnce
  void setStripeWidth(String src, int stripeWidth)
    throws IOException;
