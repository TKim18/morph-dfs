...
public class RouterClientProtocol implements ClientProtocol {
  ...
  public LocatedBlock addHybridBlock(String src, String clientName,
           ExtendedBlock previous, ExtendedBlock previousParity, ExtendedBlock previousReplica,
           boolean parityEnabled, DatanodeInfo[] excludedNodes, long fileId,
           String[] favoredNodes, EnumSet<AddBlockFlag> addBlockFlags)
      throws IOException {
    rpcServer.checkOperation(NameNode.OperationCategory.WRITE);

    RemoteMethod method = new RemoteMethod("addHybridBlock",
        new Class<?>[] {String.class, String.class,
            ExtendedBlock.class, ExtendedBlock.class,
            ExtendedBlock.class, boolean.class, DatanodeInfo[].class,
            long.class, String[].class, EnumSet.class},
        new RemoteParam(), clientName, previous,
        previousParity, previousReplica, parityEnabled, excludedNodes, fileId,
        favoredNodes, addBlockFlags);
  ...
  public LocatedBlock[] addBlocks(String src, String clientName,
        ...
        ExtendedBlock partialParity, DatanodeInfo[] excludedNodes,
    ...
    RemoteMethod method = new RemoteMethod("addBlocks",
      new Class<?>[] {String.class, String.class, ExtendedBlock.class,
        ExtendedBlock[].class, ExtendedBlock.class,
        DatanodeInfo[].class, long.class, String[].class,
        EnumSet.class, int.class, int.class},
      new RemoteParam(), clientName, previousData,
            previousParities, partialParity, excludedNodes, fileId,
      favoredNodes, addBlockFlags, numStripes, numGroups);

    if (previousData != null) {
      return new LocatedBlock[]{rpcClient.invokeSingle(previousData, method, LocatedBlock.class)};
    }

    final List<RemoteLocation> locations =
      rpcServer.getLocationsForPath(src, true);
    // TODO verify the excludedNodes and favoredNodes are acceptable to this NN
    return new LocatedBlock[]{rpcClient.invokeSequential(
      locations, method, LocatedBlock.class, null)};
  }
  ...
  public boolean complete(String src, String clientName, ExtendedBlock last,
      ExtendedBlock[] parities, long fileId) throws IOException {
    rpcServer.checkOperation(NameNode.OperationCategory.WRITE);

    RemoteMethod method = new RemoteMethod("complete",
        new Class<?>[] {String.class, String.class, ExtendedBlock.class,
            ExtendedBlock[].class, long.class},
        new RemoteParam(), clientName, last, parities, fileId);
  ...
  public void setStripeWidth(String src, int stripeWidth)
    throws IOException {
    erasureCoding.setStripeWidth(src, stripeWidth);
  }
      ...
      try {
        ...
        if (entry != null) {
          ...
          if (fInfo != null) {
            ...
            flags = DFSUtil
                .getFlags(fInfo.isEncrypted(), fInfo.isErasureCoded(), false,
